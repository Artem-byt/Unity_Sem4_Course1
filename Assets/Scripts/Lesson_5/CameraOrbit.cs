...
public class CameraOrbit : MonoBehaviour
{
    ...
    private Vector3 _ñameraHalfExtends 
    {
        get 
        { 
            Vector3 halfExtends; halfExtends.y = _regularCamera.nearClipPlane * Mathf.Tan(.5f * Mathf.Deg2Rad * _regularCamera.fieldOfView); 
    ...
    { 
        ...
        { 
            ...
            float t = 1.0f; if (distance > .01f && _focusCentering > .0f) 
            { 
